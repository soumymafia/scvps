...
curl -sS https://raw.githubusercontent.com/rizkyckj/AutoScriptXray/master/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -q -O /usr/bin/trial "https://raw.githubusercontent.com/rizkyckj/rvpnstores/master/udp-custom/ssh/trial.sh"
...
wget -O user-lock "https://raw.githubusercontent.com/rizkyckj/rvpnstores/master/ssh/user-lock.sh"
wget -O user-unlock "https://raw.githubusercontent.com/rizkyckj/rvpnstores/master/ssh/user-unlock.sh"
...
wget -O bw "https://raw.githubusercontent.com/rizkyckj/rvpnstores/master/menu/bw.sh"
