...
echo -e "⟨ SSH OVPN Account ⟩" | tee -a /etc/log-create-ssh.log
echo -e "◇━━━━━━━━━━━━━◇" | tee -a /etc/log-create-ssh.log
...
echo -e "◇━━━━━━━━━━━━━◇" | tee -a /etc/log-create-ssh.log
echo -e "» Payload WSS : GET wss://isi_bug_disini HTTP/1.1[crlf]Host: ${domen}[crlf]Upgrade: websocket[crlf][crlf]" | tee -a /etc/log-create-ssh.log
echo -e "◇━━━━━━━━━━━━━◇" | tee -a /etc/log-create-ssh.log
echo -e "» Payload WS  : GET / HTTP/1.1[crlf]Host: $domen[crlf]Upgrade: websocket[crlf][crlf]" | tee -a /etc/log-create-ssh.log
echo -e "◇━━━━━━━━━━━━━◇" | tee -a /etc/log-create-ssh.log
else
