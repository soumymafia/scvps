...
###
BURIQ () {
    curl -sS https://raw.githubusercontent.com/rizkyckj/izin/master/izin > /root/tmp
...
# https://raw.githubusercontent.com/rizkyckj/izin/master/izin
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/rizkyckj/izin/master/izin | grep $MYIP | awk '{print $2}')
