...
echo -e ""
echo -e "${CYAN}┌──────────────────────────────────┐"
echo -e "${CYAN}│$COLOR1 ${NC} ${COLBG1}        ${WH} SCRIPT BY RVPN PREMIUM               ${NC} $COLOR1 $NC"
echo -e "${CYAN}│"
echo -e "${CYAN}│$COLOR1 ${NC} ${COLBG1}        ${WH} IP VPS : $ip_vps               ${NC} $COLOR1 $NC"
echo -e "${CYAN}│$COLOR1 ${NC} ${COLBG1}        ${WH} DOMAIN : $domain               ${NC} $COLOR1 $NC"
echo -e "${CYAN}└──────────────────────────────────┘"
...
echo -e "${COLOR1}[03]${NC} • ${YELLOW}VLESS${NC}"    
echo -e "${COLOR1}[04]${NC} • ${YELLOW}TROJAN${NC}"
