...
echo -e "│ STATUS    \e[0m: Tak ada penyakit yang tak bisa disembuhkan kecuali kemalasan. Tak ada obat yang tak berguna selain kurangnya pengetahuan"
echo -e "┌──────────────────────────────────────┐"
echo -e "|\e[33m VERSION\E[0m: 2.8""	  ""$NC${BICyan}HARI INI${NC}: ${red}$ttoday $NC"
echo -e "│\e[33m CLIENT \E[0m: PREMIUM""  ""$NC${BICyan}BULAN INI${NC}: ${red}$tmon $NC"
