...
echo -e ""
echo -p "┌──────────────────────────────────────┐"
echo -p "|\e[33m VERSION\E[0m: 2.8""	  ""$NC${BICyan}HARI INI${NC}: ${red}$ttoday $NC"
echo -p "│\e[33m CLIENT \E[0m: PREMIUM""  ""$NC${BICyan}BULAN INI${NC}: ${red}$tmon $NC"
echo -p "|\e[33m LISENSI\E[0m: LIFETIME" 	
echo -p "└──────────────────────────────────────┘" 
echo -e ""
